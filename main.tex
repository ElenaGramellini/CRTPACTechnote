...
Authors: David Caratelli, Elena Gramellini, Michelle Stancari\\
Please send comments to elenag@fnal.gov
\end{center}
\vspace*{1cm}
...
We present here a preliminary study of the impact of the MicroBooNE Cosmic Ray Tagger (CRT) on neutrino selection, particularly for electron neutrinos. Scope of this note is to show metrics for CRT stability usable at the analysis level as well as to show the rejection power and efficiency of two tools: the CRT Veto and the CRT Distance Tagger. An evaluation of the the $\nu_e$ preselection significance with and without the CRT cuts in the cutflow is then presented.
